...
/** Eigene Chat-Nachricht löschen - nur die Autorin/der Autor selbst. Getrennt von
 * app/api/admin/forum/chat/[id] (Admin-Moderation gemeldeter Inhalte, prüft role "admin" statt
 * Eigentümerschaft). */
