...
Lesetext oder eigenständigem Schreiben (Lesetext, Lückentext, lange offene Fragen) sind für sie
NICHT geeignet und sollen vermieden werden. Nutze stattdessen bevorzugt diese für die Stufe
geeigneten Typen:
...
- Achte darauf, dass der Inhalt klar zur genannten Grundkompetenz passt (bzw. bei "gemischt" die am besten passende der sieben Grundkompetenzen - Selbsterkenntnis, Schöpfung/Verantwortung, Glaubensbasis, Religiöses Handeln, Umgang mit Quellentexten, Pluralitätsfähigkeit, Zwischenmenschliche Perspektive - triffst). Passt das vorgegebene Thema nicht auf Anhieb zur genannten Grundkompetenz, wähle bewusst den Blickwinkel/Aspekt des Themas, der wirklich zu dieser Grundkompetenz gehört (z.B. bei "Religiöses Handeln – Ibada" und Thema "Propheten": wie die Propheten selbst gebetet/Allah gedient haben, statt nur wer sie waren) - ignoriere die Grundkompetenz nicht einfach zugunsten des naheliegenderen Blickwinkels.${schulstufenThemenHinweis}
