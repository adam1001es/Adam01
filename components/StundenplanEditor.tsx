...
function leereFormWerte(wochentag: number): FormWerte {
  return { wochentag, beginn: "", ende: "", schule: "", klasse: "", schuelerangabe: "" };
}
                ...
                {tagesEintraege.map((eintrag) =>
                  formFuer?.modus === "bearbeiten" && formFuer.id === eintrag.id ? (
                    ...
                    <button
                      ...
                      className="group block w-full rounded-xl border border-amber-200 bg-surface p-3 text-left shadow-sm transition hover:-translate-y-0.5 hover:shadow-card-werkzeuge"
                    >
