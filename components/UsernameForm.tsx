    ...
    <form onSubmit={handleSubmit} className="space-y-3">
      <label className="block max-w-xs">
        ...
        <input
          ...
          placeholder="z.B. m.mustermann oder محمد.علي"
          minLength={3}
          maxLength={20}
        />
        <span className="mt-1.5 block text-xs leading-relaxed text-slate-400">
          3-20 Zeichen: lateinische oder arabische Buchstaben (Groß-/Kleinschreibung bei
          lateinischen möglich), Ziffern, Punkt, Bindestrich, Unterstrich. Danach kannst du dich
          damit statt mit der E-Mail-Adresse anmelden - die Groß-/Kleinschreibung spielt beim
          Anmelden keine Rolle.
        </span>
      </label>
