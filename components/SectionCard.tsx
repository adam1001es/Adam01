...
export default function SectionCard({
  ...
  return (
    <section
      className={`relative overflow-hidden rounded-2xl border border-slate-200 border-l-4 bg-surface p-6 shadow-card ${stil.kante}`}
    >
      {/* Dezenter Farbschimmer, an der Akzentkante verankert und nach rechts auslaufend - siehe
          lib/sectionFarben.ts "wash". Rein dekorativ, deshalb pointer-events-none und hinter dem
          Inhalt (der Rest bleibt in einem eigenen, positionierten Wrapper darüber). */}
